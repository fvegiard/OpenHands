...
description: 'Agent Builder and Interviewer Role | Triggers: /agent-builder'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# agent_sdk_builder (openagent)

> Mavis-format port of openagent/OpenHands `skills/agent_sdk_builder.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/agent_sdk_builder.md
