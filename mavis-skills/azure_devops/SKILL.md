---
name: azure_devops
description: 'Convert PAT to base64 | Triggers: azure_devops, azure'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# azure_devops (openagent)

> Mavis-format port of openagent/OpenHands `skills/azure_devops.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/azure_devops.md
