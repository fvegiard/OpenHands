...
description: 'First-time User Conversation with OpenHands | Triggers: /onboard'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# onboarding_agent (openagent)

> Mavis-format port of openagent/OpenHands `skills/onboarding_agent.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/onboarding_agent.md
> Triggers: /onboard
