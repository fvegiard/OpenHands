---
name: SSH Microagent
description: 'SSH Microagent | Triggers: ssh, remote server, remote machine, remote
  host, remote connection, secure shell, ssh keys'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# SSH Microagent (openagent)

> Mavis-format port of openagent/OpenHands `skills/SSH Microagent.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/SSH Microagent.md
> Triggers: ssh, remote server, remote machine, remote host, remote connection, secure shell, ssh keys
