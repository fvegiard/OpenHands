...
description: "openagent skill — see skills/codereview-roasted.md upstream. Triggers: /codereview-roasted"
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# codereview-roasted (openagent)

> Mavis-format port of openagent/OpenHands `skills/codereview-roasted.md`.
> Triggers: /codereview-roasted
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/codereview-roasted.md
