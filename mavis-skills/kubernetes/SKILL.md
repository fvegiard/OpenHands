---
name: kubernetes
description: 'Kubernetes Local Development with KIND | Triggers: kubernetes, k8s,
  kube'
...
> Mavis-format port of openagent/OpenHands `skills/kubernetes.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/kubernetes.md
