---
name: agent_memory
description: ' | Triggers: /remember'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# agent_memory (openagent)

> Mavis-format port of openagent/OpenHands `skills/agent_memory.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/agent_memory.md
> Triggers: /remember
