...
description: ' | Triggers: bitbucket_data_center, bitbucket data center'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# bitbucket_data_center (openagent)

> Mavis-format port of openagent/OpenHands `skills/bitbucket_data_center.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/bitbucket_data_center.md
> Triggers: bitbucket_data_center, bitbucket data center
