---
name: swift-linux
description: 'Swift Installation Guide for Debian Linux | Triggers: swift-linux, swift-debian,
  swift-installation'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# swift-linux (openagent)

> Mavis-format port of openagent/OpenHands `skills/swift-linux.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/swift-linux.md
> Triggers: swift-linux, swift-debian, swift-installation
