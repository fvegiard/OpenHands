---
name: code-review
description: "openagent skill — see skills/code-review.md upstream. Triggers: /code-review"
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# code-review (openagent)

> Mavis-format port of openagent/OpenHands `skills/code-review.md`.
> Triggers: /code-review
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/code-review.md
