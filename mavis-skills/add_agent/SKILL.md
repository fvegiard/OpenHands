---
name: add_agent
description: ' | Triggers: new agent, new microagent, create agent, create an agent,
  create microagent, create a microagent, add agent, add an agent, add microagent,
  add a microagent, microagent template'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# add_agent (openagent)

> Mavis-format port of openagent/OpenHands `skills/add_agent.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/add_agent.md
> Triggers: new agent, new microagent, create agent, create an agent, create microagent, create a microagent, add agent, add an agent, add microagent, add a microagent, microagent template
