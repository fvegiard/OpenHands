---
name: bitbucket
description: ' | Triggers: bitbucket, git'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# bitbucket (openagent)

> Mavis-format port of openagent/OpenHands `skills/bitbucket.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/bitbucket.md
> Triggers: bitbucket, git
