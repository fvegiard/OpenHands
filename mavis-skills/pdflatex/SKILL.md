---
name: pdflatex
description: ' | Triggers: pdflatex'
license: MIT (plugin glue) / OpenHands LICENSE (upstream)
---

# pdflatex (openagent)

> Mavis-format port of openagent/OpenHands `skills/pdflatex.md`.
> Upstream: https://github.com/All-Hands-AI/OpenHands/blob/main/skills/pdflatex.md
> Triggers: pdflatex
